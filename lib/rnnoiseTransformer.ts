...
export function getRnnoiseTransformer (rnnoise: Rnnoise): (audioData: AudioData, controller:TransformStreamDefaultController<AudioData>) => void {
  let buffer = new Float32Array()
  return (audioData: AudioData, controller: TransformStreamDefaultController<AudioData>) => {
    // console.log(
    //   'audioData',
    //   audioData,
    //   rnnoise
